...
<html>
    ...
    <body>
        ...
        <main>
            <section>
                <h2><i class="calendar icon"></i>ACTIVIDADES</h2>
                ...
                <table class="ui celled table" id="exportTable">
                    <thead>
                        ...
                        <%
                            ...
                            int i = 1;
                            for(DetailClient temp: ac2.listDetailActivity(codCli)){
                        %>
            ...
            <div id="register-activity" class="ui stacked segment">
                <h2>REGISTRAR NUEVA ACTIVIDAD</h2>
                <div class="ui divider"></div>
                <form class="ui form" action="pasarDatosActividad.jsp">
